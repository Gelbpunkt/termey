  ...
  })()(
    {
        ...
        function(require, module, exports) {
          ...
          var AccessibilityManager = (function(_super) {
            ...
            function AccessibilityManager(_terminal, _dimensions) {
              ...
              _this._rowElements[0].addEventListener(
                "focus",
                _this._topBoundaryFocusListener
              );
              _this._rowElements[
                _this._rowElements.length - 1
              ].addEventListener("focus", _this._bottomBoundaryFocusListener);
              _this._refreshRowsDimensions();
              _this._accessibilityTreeRoot.appendChild(_this._rowContainer);
              _this._renderRowsDebouncer = new RenderDebouncer_1.RenderDebouncer(
              ...
              _this._terminal.element.insertAdjacentElement(
                "afterbegin",
                _this._accessibilityTreeRoot
              );
              _this.register(_this._renderRowsDebouncer);
              _this.register(
                _this._terminal.onResize(function(e) {
                  return _this._onResize(e.rows);
                })
              );
              _this.register(
                _this._terminal.onRender(function(e) {
                  return _this._refreshRows(e.start, e.end);
                })
              );
              _this.register(
                _this._terminal.onScroll(function() {
                  return _this._refreshRows();
                })
              );
              _this.register(
                _this._terminal.addDisposableListener("a11y.char", function(
                  char
                ) {
              ...
              _this.register(
                _this._terminal.onLineFeed(function() {
                  return _this._onChar("\n");
                })
              );
              _this.register(
                _this._terminal.addDisposableListener("a11y.tab", function(
                  spaceCount
                ) {
              ...
              _this.register(
                _this._terminal.onKey(function(e) {
                  return _this._onKey(e.key);
                })
              );
              _this.register(
                _this._terminal.addDisposableListener("blur", function() {
              ...
              _this.register(
                Lifecycle_1.addDisposableDomListener(
                  window,
                  "resize",
                  function() {
                    return _this._refreshRowsDimensions();
            ...
            AccessibilityManager.prototype._onBoundaryFocus = function(
              e,
              position
            ) {
              var boundaryElement = e.target;
              var beforeBoundaryElement = this._rowElements[
                position === 0 ? 1 : this._rowElements.length - 2
              ];
              var posInSet = boundaryElement.getAttribute("aria-posinset");
              var lastRowPos =
                position === 0 ? "1" : "" + this._terminal.buffer.lines.length;
              ...
              topBoundaryElement.removeEventListener(
                "focus",
                this._topBoundaryFocusListener
              );
              bottomBoundaryElement.removeEventListener(
                "focus",
            ...
            AccessibilityManager.prototype._onResize = function(rows) {
              ...
              for (
                var i = this._rowContainer.children.length;
              ...
              if (this._liveRegionLineCount < MAX_ROWS_TO_READ + 1) {
                ...
                if (Platform_1.isMac) {
                  if (
                    ...
                    setTimeout(function() {
                      _this._accessibilityTreeRoot.appendChild(
                        _this._liveRegion
                      );
                    }, 0);
                  }
            ...
            AccessibilityManager.prototype._renderRows = function(start, end) {
              ...
              for (var i = start; i <= end; i++) {
                var lineData = buffer.translateBufferLineToString(
                  buffer.ydisp + i,
                  true
                );
                ...
                if (element) {
                  element.textContent =
                    lineData.length === 0 ? Strings.blankLine : lineData;
            ...
            AccessibilityManager.prototype.setDimensions = function(
              dimensions
            ) {
              this._dimensions = dimensions;
              this._refreshRowsDimensions();
            };
            AccessibilityManager.prototype._refreshRowDimensions = function(
              element
            ) {
        ...
        function(require, module, exports) {
          ...
          var Buffer = (function() {
            function Buffer(_terminal, _hasScrollback) {
              ...
              this.markers = [];
              this._nullCell = BufferLine_1.CellData.fromCharData([
                0,
                BufferLine_1.NULL_CELL_CHAR,
                BufferLine_1.NULL_CELL_WIDTH,
                BufferLine_1.NULL_CELL_CODE
              ]);
              this._whitespaceCell = BufferLine_1.CellData.fromCharData([
                0,
                BufferLine_1.WHITESPACE_CELL_CHAR,
                BufferLine_1.WHITESPACE_CELL_WIDTH,
                BufferLine_1.WHITESPACE_CELL_CODE
              ]);
            ...
            Buffer.prototype.getBlankLine = function(attr, isWrapped) {
              return new BufferLine_1.BufferLine(
                this._terminal.cols,
            ...
            Buffer.prototype.clear = function() {
              ...
              this.y = 0;
              this.x = 0;
              this.lines = new CircularList_1.CircularList(
                  ...
                  for (var y = this._rows; y < newRows; y++) {
                    if (this.lines.length < newRows + this.ybase) {
                      if (
                        ...
                        this.lines.push(
                          new BufferLine_1.BufferLine(newCols, nullCell)
                        );
                      }
                    }
                  }
            ...
            Object.defineProperty(Buffer.prototype, "_isReflowEnabled", {
              get: function() {
                return (
                  this._hasScrollback && !this._terminal.options.windowsMode
                );
              },
              enumerable: true,
              configurable: true
            ...
            Buffer.prototype._reflowLarger = function(newCols, newRows) {
              var toRemove = BufferReflow_1.reflowLargerGetLinesToRemove(
                this.lines,
                this._cols,
                newCols,
                this.ybase + this.y,
                this.getNullCell(BufferLine_1.DEFAULT_ATTR_DATA)
              );
              if (toRemove.length > 0) {
                var newLayoutResult = BufferReflow_1.reflowLargerCreateNewLayout(
                  this.lines,
                  toRemove
                );
                BufferReflow_1.reflowLargerApplyNewLayout(
                  this.lines,
                  newLayoutResult.layout
                );
            ...
            Buffer.prototype._reflowLargerAdjustViewport = function(
              newCols,
              newRows,
              countRemoved
            ) {
            ...
            Buffer.prototype._reflowSmaller = function(newCols, newRows) {
              ...
              for (var y = this.lines.length - 1; y >= 0; y--) {
                ...
                if (
                  !nextLine ||
                  (!nextLine.isWrapped &&
                    nextLine.getTrimmedLength() <= newCols)
                ) {
                  continue;
                }
                ...
                var lastLineLength = wrappedLines[
                  wrappedLines.length - 1
                ].getTrimmedLength();
                var destLineLengths = BufferReflow_1.reflowSmallerGetNewLineLengths(
                  wrappedLines,
                  this._cols,
                  newCols
                );
                ...
                if (this.ybase === 0 && this.y !== this.lines.length - 1) {
                  trimmedLines = Math.max(
                    0,
                    this.y - this.lines.maxLength + linesToAdd
                  );
                } else {
                  trimmedLines = Math.max(
                    0,
                    this.lines.length - this.lines.maxLength + linesToAdd
                  );
                }
                var newLines = [];
                for (var i = 0; i < linesToAdd; i++) {
                  var newLine = this.getBlankLine(
                    BufferLine_1.DEFAULT_ATTR_DATA,
                    true
                  );
                ...
                while (srcLineIndex >= 0) {
                  ...
                  if (srcCol === 0) {
                    ...
                    srcCol = BufferReflow_1.getWrappedLineTrimmedLength(
                      wrappedLines,
                      wrappedLinesIndex,
                      this._cols
                    );
                  ...
                  if (this.ybase === 0) {
                    ...
                    if (
                      ...
                      Math.min(
                        ...
                        this.lines.length + countToInsert
                      ) -
                        newRows
                    ) {
              ...
              if (toInsert.length > 0) {
                ...
                var amountToTrim = Math.max(
                  0,
                  originalLinesLength + countToInsert - this.lines.maxLength
                );
                if (amountToTrim > 0) {
            ...
            Buffer.prototype.stringIndexToBufferIndex = function(
              lineIndex,
              stringIndex,
              trimRight
            ) {
              ...
              while (stringIndex) {
                ...
                var length_1 = trimRight
                  ? line.getTrimmedLength()
                  : line.length;
                for (var i = 0; i < length_1; ++i) {
                  if (line.get(i)[BufferLine_1.CHAR_DATA_WIDTH_INDEX]) {
                    stringIndex -=
                      line.get(i)[BufferLine_1.CHAR_DATA_CHAR_INDEX].length ||
                      1;
                  }
                  if (stringIndex < 0) {
                    return [lineIndex, i];
            ...
            Buffer.prototype.getWrappedRangeForLine = function(y) {
              ...
              while (
                last + 1 < this.lines.length &&
                this.lines.get(last + 1).isWrapped
              ) {
                last++;
              }
            ...
            Buffer.prototype.addMarker = function(y) {
              ...
              marker.register(
                this.lines.onTrim(function(amount) {
                  marker.line -= amount;
                  if (marker.line < 0) {
                    marker.dispose();
                  }
              ...
              marker.register(
                this.lines.onInsert(function(event) {
              ...
              marker.register(
                this.lines.onDelete(function(event) {
                  if (
                    marker.line >= event.index &&
            ...
            Buffer.prototype.iterator = function(
              ...
              return new BufferStringIterator(
                this,
                trimRight,
                startIndex,
                endIndex,
          ...
          var BufferStringIterator = (function() {
            ...
            BufferStringIterator.prototype.next = function() {
              ...
              for (var i = range.first; i <= range.last; ++i) {
                result += this._buffer.translateBufferLineToString(
                  i,
                  this._trimRight
                );
              }
          ...
          var CompositionHelper = (function() {
            ...
            CompositionHelper.prototype._finalizeComposition = function(
              ...
              if (!waitForPropagation) {
                this._isSendingComposition = false;
                var input = this._textarea.value.substring(
                ...
                setTimeout(function() {
                  if (_this._isSendingComposition) {
                    ...
                    if (_this._isComposing) {
                      input = _this._textarea.value.substring(
      ...
      8: [
        function(require, module, exports) {
          ...
          var TransitionTable = (function() {
            ...
            TransitionTable.prototype.add = function(
              code,
              state,
              action,
              next
            ) {
              this.table[(state << 8) | code] =
                ((action | 0) << 4) | (next === undefined ? state : next);
            };
            TransitionTable.prototype.addMany = function(
              codes,
              state,
              action,
              next
          ...
          var EscapeSequenceParser = (function(_super) {
            ...
            EscapeSequenceParser.prototype.setPrintHandler = function(
              callback
            ) {
            ...
            EscapeSequenceParser.prototype.setExecuteHandler = function(
              flag,
              callback
            ) {
              this._executeHandlers[flag.charCodeAt(0)] = callback;
            };
            EscapeSequenceParser.prototype.clearExecuteHandler = function(
              flag
            ) {
            ...
            EscapeSequenceParser.prototype.addCsiHandler = function(
              flag,
              callback
            ) {
            ...
            EscapeSequenceParser.prototype.setCsiHandler = function(
              flag,
              callback
            ) {
            ...
            EscapeSequenceParser.prototype.setCsiHandlerFallback = function(
              callback
            ) {
              this._csiHandlerFb = callback;
            };
            EscapeSequenceParser.prototype.setEscHandler = function(
              collectAndFlag,
              callback
            ) {
              this._escHandlers[collectAndFlag] = callback;
            };
            EscapeSequenceParser.prototype.clearEscHandler = function(
              collectAndFlag
            ) {
              if (this._escHandlers[collectAndFlag])
                delete this._escHandlers[collectAndFlag];
            };
            EscapeSequenceParser.prototype.setEscHandlerFallback = function(
              callback
            ) {
              this._escHandlerFb = callback;
            };
            EscapeSequenceParser.prototype.addOscHandler = function(
              ident,
              callback
            ) {
            ...
            EscapeSequenceParser.prototype.setOscHandler = function(
              ident,
              callback
            ) {
            ...
            EscapeSequenceParser.prototype.setOscHandlerFallback = function(
              callback
            ) {
              this._oscHandlerFb = callback;
            };
            EscapeSequenceParser.prototype.setDcsHandler = function(
              collectAndFlag,
              handler
            ) {
              this._dcsHandlers[collectAndFlag] = handler;
            };
            EscapeSequenceParser.prototype.clearDcsHandler = function(
              collectAndFlag
            ) {
              if (this._dcsHandlers[collectAndFlag])
                delete this._dcsHandlers[collectAndFlag];
            };
            EscapeSequenceParser.prototype.setDcsHandlerFallback = function(
              handler
            ) {
              this._dcsHandlerFb = handler;
            };
            EscapeSequenceParser.prototype.setErrorHandler = function(
              callback
            ) {
              ...
              for (var i = 0; i < length; ++i) {
                ...
                if (currentState === 4 && (code > 0x2f && code < 0x39)) {
                  params[params.length - 1] =
                    params[params.length - 1] * 10 + code - 48;
                  continue;
                }
                transition =
                  table[
                    (currentState << 8) |
                      (code < 0xa0 ? code : NON_ASCII_PRINTABLE)
                  ];
                switch (transition >> 4) {
                  case 2:
                    print = ~print ? print : i;
        ...
        function(require, module, exports) {
          ...
          var DECRQSS = (function() {
            ...
            DECRQSS.prototype.put = function(data, start, end) {
              this._data = TypedArrayUtils_1.concat(
                this._data,
          ...
          var InputHandler = (function(_super) {
            ...
            function InputHandler(_terminal, _parser) {
              ...
              _this._parser.setCsiHandlerFallback(function(
                collect,
                params,
                flag
              ) {
              ...
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.BEL,
                function() {
                  return _this.bell();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.LF,
                function() {
                  return _this.lineFeed();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.VT,
                function() {
                  return _this.lineFeed();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.FF,
                function() {
                  return _this.lineFeed();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.CR,
                function() {
                  return _this.carriageReturn();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.BS,
                function() {
                  return _this.backspace();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.HT,
                function() {
                  return _this.tab();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.SO,
                function() {
                  return _this.shiftOut();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C0.SI,
                function() {
                  return _this.shiftIn();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C1.IND,
                function() {
                  return _this.index();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C1.NEL,
                function() {
                  return _this.nextLine();
                }
              );
              _this._parser.setExecuteHandler(
                EscapeSequences_1.C1.HTS,
                function() {
                  return _this.tabSet();
                }
              );
            ...
            InputHandler.prototype.print = function(data, start, end) {
              ...
              for (var pos = start; pos < end; ++pos) {
                ...
                if (screenReaderMode) {
                  this._terminal.emit(
                    "a11y.char",
                    TextDecoder_1.stringFromCodePoint(code)
                  );
                }
                if (!chWidth && buffer.x) {
            ...
            InputHandler.prototype.tab = function() {
              ...
              if (this._terminal.options.screenReaderMode) {
                this._terminal.emit(
                  "a11y.tab",
                  this._terminal.buffer.x - originalX
                );
              }
            };
            ...
            InputHandler.prototype._eraseInBufferLine = function(
              y,
              start,
              end,
              clearWrap
            ...
            InputHandler.prototype.insertLines = function(params) {
              ...
              while (param--) {
                ...
                buffer.lines.splice(
                  row,
                  0,
                  buffer.getBlankLine(this._terminal.eraseAttrData())
                );
              }
              this._terminal.updateRange(buffer.y);
            ...
            InputHandler.prototype.scrollUp = function(params) {
              ...
              while (param--) {
                ...
                buffer.lines.splice(
                  buffer.ybase + buffer.scrollBottom,
                  0,
                  buffer.getBlankLine(BufferLine_1.DEFAULT_ATTR_DATA)
                );
              }
            ...
            InputHandler.prototype.repeatPrecedingCharacter = function(params) {
              ...
              line.replaceCells(
                buffer.x,
                buffer.x + (params[0] || 1),
                this._workCell.content !== undefined
                  ? this._workCell
                  : buffer.getNullCell(BufferLine_1.DEFAULT_ATTR_DATA)
              );
            };
            InputHandler.prototype.sendDeviceAttributes = function(
              params,
              collect
            ) {
              if (params[0] > 0) {
              ...
              if (!collect) {
                ...
                if (this._terminal.is("xterm")) {
                  this._terminal.handler(
                    EscapeSequences_1.C0.ESC + "[>0;276;0c"
                  );
                } else if (this._terminal.is("rxvt-unicode")) {
                  this._terminal.handler(
                    EscapeSequences_1.C0.ESC + "[>85;95;0c"
                  );
                } else if (this._terminal.is("linux")) {
            ...
            InputHandler.prototype.charAttributes = function(params) {
              if (params.length === 1 && params[0] === 0) {
                this._terminal.curAttrData.fg =
                  BufferLine_1.DEFAULT_ATTR_DATA.fg;
                this._terminal.curAttrData.bg =
                  BufferLine_1.DEFAULT_ATTR_DATA.bg;
                return;
              }
              var l = params.length;
              var p;
              ...
              for (var i = 0; i < l; i++) {
                ...
                if (p >= 30 && p <= 37) {
                  ...
                  attr.fg |=
                    BufferLine_1.DEFAULT_ATTR_DATA.fg & (255 | 16777215);
                } else if (p === 49) {
                  attr.bg &= ~(50331648 | 16777215);
                  attr.bg |=
                    BufferLine_1.DEFAULT_ATTR_DATA.bg & (255 | 16777215);
                } else if (p === 38) {
                  if (params[i + 1] === 2) {
                    i += 2;
                    attr.fg |= 50331648;
                    attr.fg &= ~16777215;
                    attr.fg |= BufferLine_1.AttributeData.fromColorRGB([
                      params[i],
                      params[i + 1],
                      params[i + 2]
                    ]);
                  ...
                  if (params[i + 1] === 2) {
                    ...
                    attr.bg |= 50331648;
                    attr.bg &= ~16777215;
                    attr.bg |= BufferLine_1.AttributeData.fromColorRGB([
                      params[i],
                      params[i + 1],
                      params[i + 2]
                    ]);
              ...
              if (!collect) {
                switch (params[0]) {
                  ...
                  case 6:
                    ...
                    this._onData.fire(
                      EscapeSequences_1.C0.ESC + "[" + y + ";" + x + "R"
                    );
                    break;
                }
              } else if (collect === "?") {
            ...
            InputHandler.prototype.selectCharset = function(collectAndFlag) {
              ...
              this._terminal.setgCharset(
                ...
                Charsets_1.CHARSETS[collectAndFlag[1]] ||
                  Charsets_1.DEFAULT_CHARSET
              );
              return;
            };
        ...
        function(require, module, exports) {
          ...
          var Linkifier = (function() {
            ...
            Linkifier.prototype._linkifyRows = function() {
              ...
              var buffer = this._terminal.buffer;
              var absoluteRowIndexStart =
                buffer.ydisp + this._rowsToLinkify.start;
              if (absoluteRowIndexStart >= buffer.lines.length) {
                return;
              }
              var absoluteRowIndexEnd =
                buffer.ydisp +
                Math.min(this._rowsToLinkify.end, this._terminal.rows) +
                1;
              var overscanLineLimit = Math.ceil(
                Linkifier.OVERSCAN_CHAR_LIMIT / this._terminal.cols
              );
              var iterator = this._terminal.buffer.iterator(
                false,
                absoluteRowIndexStart,
                absoluteRowIndexEnd,
                overscanLineLimit,
                overscanLineLimit
              );
              while (iterator.hasNext()) {
                ...
                for (var i = 0; i < this._linkMatchers.length; i++) {
                  this._doLinkifyRow(
                    lineData.range.first,
                    lineData.content,
                    this._linkMatchers[i]
                  );
                }
              }
            ...
            Linkifier.prototype._doLinkifyRow = function(
              ...
              var _loop_1 = function() {
                ...
                var bufferIndex = this_1._terminal.buffer.stringIndexToBufferIndex(
                  rowIndex,
                  stringIndex
                );
                if (bufferIndex[0] < 0) {
                ...
                if (matcher.validationCallback) {
                  matcher.validationCallback(uri, function(isValid) {
                    ...
                    if (isValid) {
                      _this._addLink(
                        bufferIndex[1],
                        bufferIndex[0] - _this._terminal.buffer.ydisp,
                        uri,
                        matcher,
                        fg
                      );
                  ...
                  this_1._addLink(
                    bufferIndex[1],
                    bufferIndex[0] - this_1._terminal.buffer.ydisp,
                    uri,
                    matcher,
                    fg
                  );
            ...
            Linkifier.prototype._addLink = function(x, y, uri, matcher, fg) {
              ...
              this._mouseZoneManager.add(
                new MouseZoneManager_1.MouseZone(
                  ...
                  function() {
                    _this._onLinkHover.fire(
                      _this._createLinkHoverEvent(x1, y1, x2, y2, fg)
                    );
                    _this._terminal.element.classList.add(
                      "xterm-cursor-pointer"
                    );
                  },
                  function(e) {
                    _this._onLinkTooltip.fire(
                      _this._createLinkHoverEvent(x1, y1, x2, y2, fg)
                    );
                  ...
                  function() {
                    _this._onLinkLeave.fire(
                      _this._createLinkHoverEvent(x1, y1, x2, y2, fg)
                    );
                    _this._terminal.element.classList.remove(
                      "xterm-cursor-pointer"
                    );
            ...
            Linkifier.prototype._createLinkHoverEvent = function(
              x1,
              y1,
              x2,
              y2,
        ...
        function(require, module, exports) {
          ...
          var MouseHelper = (function() {
            ...
            MouseHelper.prototype.getCoords = function(
              ...
              coords[1] = Math.ceil(
                coords[1] / this._renderCoordinator.dimensions.actualCellHeight
              );
              coords[0] = Math.min(
                Math.max(coords[0], 1),
        ...
        function(require, module, exports) {
          ...
          var MouseZoneManager = (function(_super) {
            ...
            function MouseZoneManager(_terminal) {
              ...
              _this.register(
                Lifecycle_2.addDisposableDomListener(
            ...
            MouseZoneManager.prototype._onClick = function(e) {
              ...
              if (
                zone &&
                currentSelectionLength === this._initialSelectionLength
              ) {
      ...
      13: [
        function(require, module, exports) {
          ...
          var SelectionManager = (function() {
            ...
            SelectionManager.prototype._areCoordsInSelection = function(
              coords,
              start,
              end
            ) {
              ...
              if (this._model.selectionEnd[1] < this._buffer.lines.length) {
                if (
                  this._buffer.lines
                    ...
                    .hasWidth(this._model.selectionEnd[0]) === 0
                ) {
            ...
            SelectionManager.prototype._onMouseUp = function(event) {
              ...
              if (
                ...
                new AltClickHandler_1.AltClickHandler(
                  event,
                  this._terminal
                ).move();
            ...
            SelectionManager.prototype._convertViewportColToCharacterIndex = function(
              bufferLine,
              coords
            ) {
              var charIndex = coords[0];
              for (var i = 0; coords[0] >= i; i++) {
                var length_1 = bufferLine.loadCell(i, this._workCell).getChars()
                  .length;
            ...
            SelectionManager.prototype._getWordAt = function(
              coords,
              allowWhitespaceOnlySelection,
              followWrappedLinesAbove,
              followWrappedLinesBelow
            ) {
              ...
              if (followWrappedLinesAbove) {
                if (start === 0 && bufferLine.getCodePoint(0) !== 32) {
                  var previousBufferLine = this._buffer.lines.get(
                    coords[1] - 1
                  );
                  if (
                    previousBufferLine &&
                    bufferLine.isWrapped &&
                    previousBufferLine.getCodePoint(this._terminal.cols - 1) !==
                      32
                  ) {
                    var previousLineWordPosition = this._getWordAt(
                      [this._terminal.cols - 1, coords[1] - 1],
                      false,
                      true,
                      false
                    );
                    if (previousLineWordPosition) {
                      var offset =
                        this._terminal.cols - previousLineWordPosition.start;
                      start -= offset;
                      length += offset;
                    }
                  }
              ...
              if (followWrappedLinesBelow) {
                if (
                  start + length === this._terminal.cols &&
                  bufferLine.getCodePoint(this._terminal.cols - 1) !== 32
                ) {
                  ...
                  if (
                    ...
                    var nextLineWordPosition = this._getWordAt(
                      [0, coords[1] + 1],
                      false,
                      false,
                      true
            ...
            SelectionManager.prototype._selectWordAt = function(
              coords,
              allowWhitespaceOnlySelection
            ) {
              var wordPosition = this._getWordAt(
                coords,
                allowWhitespaceOnlySelection
              );
              if (wordPosition) {
                ...
                get: function() {
                  ...
                  if (!this.selectionEnd || this.areSelectionValuesReversed()) {
                    ...
                    if (startPlusLength > this._terminal.cols) {
                      return [
                        startPlusLength % this._terminal.cols,
                        this.selectionStart[1] +
                          Math.floor(startPlusLength / this._terminal.cols)
                      ];
                    }
        ...
        function(require, module, exports) {
          ...
          var Terminal = (function(_super) {
            ...
            Terminal.prototype._setup = function() {
              ...
              this.soundManager =
                this.soundManager || new SoundManager_1.SoundManager(this);
            ...
            Terminal.prototype.setOption = function(key, value) {
              ...
              if (CONSTRUCTOR_ONLY_OPTIONS.indexOf(key) !== -1) {
                console.error(
                  'Option "' + key + '" can only be set in the constructor'
                );
              }
                ...
                case "screenReaderMode":
                  if (value) {
                    if (
                      ...
                      this._accessibilityManager = new AccessibilityManager_1.AccessibilityManager(
                        this,
                    ...
                    function(event) {
                      if (event.button === 2) {
                        Clipboard_1.rightClickHandler(
                          ...
                          _this,
                          _this.selectionManager,
                          _this.options.rightClickSelectsWord
                        );
                      }
                    }
                  )
            ...
            Terminal.prototype.open = function(parent) {
              ...
              this._compositionHelper = new CompositionHelper_1.CompositionHelper(
                this.textarea,
              ...
              this._renderCoordinator = new RenderCoordinator_1.RenderCoordinator(
                renderer,
                this.rows,
                this.screenElement
              );
              ...
              this.register(
                this.onResize(function() {
                  return _this._renderCoordinator.onResize(
                    _this.cols,
                    _this.rows
                  );
                })
              ...
              this.register(
                this.selectionManager.onRedrawRequest(function(e) {
                  return _this._renderCoordinator.onSelectionChanged(
                    e.start,
                    e.end,
                    e.columnSelectMode
                  );
              ...
              this.register(
                this.selectionManager.onLinuxMouseSelection(function(text) {
              ...
              this.mouseHelper = new MouseHelper_1.MouseHelper(
                this._renderCoordinator
              );
            ...
            Terminal.prototype._createRenderer = function() {
              switch (this.options.rendererType) {
                case "canvas":
                  return new Renderer_1.Renderer(
                    this,
                    this._colorManager.colors
                  );
                  break;
                case "dom":
                  return new DomRenderer_1.DomRenderer(
                    this,
                    this._colorManager.colors
                  );
                  break;
            ...
            Terminal.prototype.bindMouse = function() {
              ...
              function getButton(ev) {
                ...
                switch (ev.overrideType || ev.type) {
                  case "mousedown":
                    button =
                      ev.button !== null && ev.button !== undefined
                        ? +ev.button
              ...
              this.register(
                Lifecycle_1.addDisposableDomListener(el, "mousedown", function(
                  ev
                ) {
                  ev.preventDefault();
                  _this.focus();
                  ...
                  var handler = function(ev) {
                    ...
                    if (moveHandler) {
                      _this._document.removeEventListener(
                        "mousemove",
                        moveHandler
                      );
                      moveHandler = null;
              ...
              this.register(
                Lifecycle_1.addDisposableDomListener(el, "wheel", function(ev) {
              ...
              this.register(
                Lifecycle_1.addDisposableDomListener(el, "touchstart", function(
                  ev
                ) {
                  if (_this.mouseEvents) return;
              ...
              this.register(
                Lifecycle_1.addDisposableDomListener(el, "touchmove", function(
                  ev
                ) {
                  if (_this.mouseEvents) return;
            ...
            Terminal.prototype.updateCursorStyle = function(ev) {
              if (
                ...
                this.selectionManager.shouldColumnSelect(ev)
              ) {
            ...
            Terminal.prototype.writeUtf8 = function(data) {
              ...
              if (
                ...
                this.writeBufferUtf8.length >= WRITE_BUFFER_PAUSE_THRESHOLD
              ) {
            ...
            Terminal.prototype._innerWriteUtf8 = function(bufferOffset) {
              ...
              while (this.writeBufferUtf8.length > bufferOffset) {
                ...
                if (
                  this._xoffSentToCatchUp &&
                  this.writeBufferUtf8.length === bufferOffset
                ) {
              ...
              if (this.writeBufferUtf8.length > bufferOffset) {
                if (bufferOffset > WRITE_BUFFER_LENGTH_THRESHOLD) {
                  this.writeBufferUtf8 = this.writeBufferUtf8.slice(
                    bufferOffset
                  );
                  bufferOffset = 0;
                }
            ...
            Terminal.prototype._innerWrite = function(bufferOffset) {
              ...
              while (this.writeBuffer.length > bufferOffset) {
                ...
                if (
                  this._xoffSentToCatchUp &&
                  this.writeBuffer.length === bufferOffset
                ) {
                  this.handler(EscapeSequences_1.C0.DC1);
                  this._xoffSentToCatchUp = false;
                }
            ...
            Terminal.prototype.registerCharacterJoiner = function(handler) {
              var joinerId = this._renderCoordinator.registerCharacterJoiner(
                handler
              );
              this.refresh(0, this.rows - 1);
              return joinerId;
            ...
            Terminal.prototype.addMarker = function(cursorYOffset) {
              ...
              return this.buffer.addMarker(
                this.buffer.ybase + this.buffer.y + cursorYOffset
              );
            };
            ...
            Terminal.prototype._keyDown = function(event) {
              if (
                ...
                this._customKeyEventHandler(event) === false
              ) {
                return false;
              }
              ...
              var result = Keyboard_1.evaluateKeyboardEvent(
                event,
              ...
              if (result.type === 3 || result.type === 2) {
                ...
                this.scrollLines(
                  result.type === 2 ? -scrollCount : scrollCount
                );
            ...
            Terminal.prototype._keyPress = function(ev) {
              ...
              if (
                this._customKeyEventHandler &&
                this._customKeyEventHandler(ev) === false
              ) {
                return false;
              }
              this.cancel(ev);
            ...
            Terminal.prototype.clear = function() {
              ...
              for (var i = 1; i < this.rows; i++) {
                this.buffer.lines.push(
                  this.buffer.getBlankLine(BufferLine_1.DEFAULT_ATTR_DATA)
                );
              }
              this.refresh(0, this.rows - 1);
              this._onScroll.fire(this.buffer.ydisp);
        ...
        function(require, module, exports) {
          ...
          var Viewport = (function(_super) {
            ...
            function Viewport(
              ...
              _this.scrollBarWidth =
                _this._viewportElement.offsetWidth -
                  _this._scrollArea.offsetWidth || FALLBACK_SCROLL_BAR_WIDTH;
              _this.register(
                Lifecycle_2.addDisposableDomListener(
                  _this._viewportElement,
                  "scroll",
                  _this._onScroll.bind(_this)
                )
              );
              setTimeout(function() {
            ...
            Viewport.prototype._innerRefresh = function() {
              ...
              var scrollTop =
                this._terminal.buffer.ydisp * this._currentRowHeight;
        ...
        function(require, module, exports) {
          ...
          function applyWindowsMode(terminal) {
            return terminal.onLineFeed(function() {
              var line = terminal.buffer.lines.get(
                terminal.buffer.ybase + terminal.buffer.y - 1
              );
              var lastChar = line.get(terminal.cols - 1);
              var nextLine = terminal.buffer.lines.get(
                terminal.buffer.ybase + terminal.buffer.y
              );
              nextLine.isWrapped =
                lastChar[BufferLine_1.CHAR_DATA_CODE_INDEX] !==
                  BufferLine_1.NULL_CELL_CODE &&
                lastChar[BufferLine_1.CHAR_DATA_CODE_INDEX] !==
                  BufferLine_1.WHITESPACE_CELL_CODE;
            });
            ...
            CircularList.prototype.splice = function(start, deleteCount) {
              ...
              if (deleteCount) {
                for (var i = start; i < this._length - deleteCount; i++) {
                  this._array[this._getCyclicIndex(i)] = this._array[
                    this._getCyclicIndex(i + deleteCount)
                  ];
                }
              ...
              for (var i = this._length - 1; i >= start; i--) {
                this._array[
                  this._getCyclicIndex(i + items.length)
      ...
      21: [
        function(require, module, exports) {
          ...
          function clone(val, depth) {
            ...
            for (var key in val) {
              clonedObject[key] =
                depth <= 1 ? val[key] : clone(val[key], depth - 1);
            }
            return clonedObject;
          }
          exports.clone = clone;
      ...
      22: [
        function(require, module, exports) {
          ...
          var EventEmitter = (function(_super) {
            ...
            EventEmitter.prototype.addDisposableListener = function(
              type,
              handler
            ) {
              var _this = this;
      ...
      25: [
        function(require, module, exports) {
          ...
          exports.isMac = contains(
            ["Macintosh", "MacIntel", "MacPPC", "Mac68K"],
            platform
          );
          exports.isIpad = platform === "iPad";
          exports.isIphone = platform === "iPhone";
          exports.isMSWindows = contains(
      ...
      29: [
        function(require, module, exports) {
          ...
          exports.DEFAULT_ATTR =
            (0 << 18) | (Types_1.DEFAULT_COLOR << 9) | (256 << 0);
          ...
          var CellData = (function(_super) {
            ...
            CellData.prototype.getChars = function() {
              ...
              if (this.content & 2097151) {
                return TextDecoder_1.stringFromCodePoint(
            ...
            CellData.prototype.setFromCharData = function(value) {
              ...
              if (value[exports.CHAR_DATA_CHAR_INDEX].length > 2) {
                ...
                if (0xd800 <= code && code <= 0xdbff) {
                  var second = value[exports.CHAR_DATA_CHAR_INDEX].charCodeAt(
                    1
                  );
                  if (0xdc00 <= second && second <= 0xdfff) {
                    this.content =
                      ((code - 0xd800) * 0x400 + second - 0xdc00 + 0x10000) |
                      (value[exports.CHAR_DATA_WIDTH_INDEX] << 22);
                  } else {
                    combined = true;
                  }
                } else {
                ...
                this.content =
                  value[exports.CHAR_DATA_CHAR_INDEX].charCodeAt(0) |
                  (value[exports.CHAR_DATA_WIDTH_INDEX] << 22);
              }
              if (combined) {
                this.combinedData = value[exports.CHAR_DATA_CHAR_INDEX];
                this.content =
                  2097152 | (value[exports.CHAR_DATA_WIDTH_INDEX] << 22);
              }
            };
          ...
          var BufferLine = (function() {
            ...
            BufferLine.prototype.get = function(index) {
              ...
              return [
                ...
                content & 2097152
                  ...
                  : cp
                  ? TextDecoder_1.stringFromCodePoint(cp)
                  : "",
                content >> 22,
                content & 2097152
                  ? this._combined[index].charCodeAt(
                      this._combined[index].length - 1
                    )
                  : cp
              ];
            };
            BufferLine.prototype.set = function(index, value) {
              this._data[index * CELL_SIZE + 1] =
                value[exports.CHAR_DATA_ATTR_INDEX];
            ...
            BufferLine.prototype.getCodePoint = function(index) {
              var content = this._data[index * CELL_SIZE + 0];
              if (content & 2097152) {
                return this._combined[index].charCodeAt(
                  this._combined[index].length - 1
                );
              }
            ...
            BufferLine.prototype.setCellFromCodePoint = function(
              index,
              codePoint,
              width,
              fg,
            ...
            BufferLine.prototype.addCodepointToCell = function(
              index,
              codePoint
            ) {
              var content = this._data[index * CELL_SIZE + 0];
              if (content & 2097152) {
                this._combined[index] += TextDecoder_1.stringFromCodePoint(
                  codePoint
                );
              } else {
                if (content & 2097151) {
                  this._combined[index] =
                    TextDecoder_1.stringFromCodePoint(content & 2097151) +
                    TextDecoder_1.stringFromCodePoint(codePoint);
                  content &= ~2097151;
                  content |= 2097152;
                } else {
            ...
            BufferLine.prototype.replaceCells = function(
              start,
              end,
              fillCellData
            ) {
            ...
            BufferLine.prototype.copyCellsFrom = function(
              src,
              srcCol,
              destCol,
              length,
            ...
            BufferLine.prototype.translateToString = function(
              trimRight,
              startCol,
              endCol
            ) {
        ...
        function(require, module, exports) {
          ...
          function reflowLargerGetLinesToRemove(
            ...
            for (var y = 0; y < lines.length - 1; y++) {
              ...
              while (srcLineIndex < wrappedLines.length) {
                var srcTrimmedTineLength = getWrappedLineTrimmedLength(
                  wrappedLines,
                  srcLineIndex,
                  oldCols
                );
                ...
                if (destCol === 0 && destLineIndex !== 0) {
                  if (
                    wrappedLines[destLineIndex - 1].getWidth(newCols - 1) === 2
                  ) {
                    wrappedLines[destLineIndex].copyCellsFrom(
                    ...
                    wrappedLines[destLineIndex - 1].setCell(
                      newCols - 1,
                      nullCell
                    );
                  }
              ...
              wrappedLines[destLineIndex].replaceCells(
                destCol,
                newCols,
                nullCell
              );
              ...
              for (var i_1 = wrappedLines.length - 1; i_1 > 0; i_1--) {
                if (
                  i_1 > destLineIndex ||
                  wrappedLines[i_1].getTrimmedLength() === 0
                ) {
                  countToRemove++;
                } else {
                  break;
          ...
          function reflowSmallerGetNewLineLengths(
            ...
            while (cellsAvailable < cellsNeeded) {
              ...
              srcCol += newCols;
              var oldTrimmedLength = getWrappedLineTrimmedLength(
                wrappedLines,
                srcLine,
                oldCols
              );
              ...
              var endsWithWide =
                wrappedLines[srcLine].getWidth(srcCol - 1) === 2;
              if (endsWithWide) {
                srcCol--;
              }
          ...
          function getWrappedLineTrimmedLength(lines, i, cols) {
            ...
            var endsInNull =
              !lines[i].hasContent(cols - 1) &&
              lines[i].getWidth(cols - 1) === 1;
              ...
              default:
                if (ev.ctrlKey && !ev.shiftKey && !ev.altKey && !ev.metaKey) {
                  ...
                  if (key) {
                    ...
                    var keyCode = ev.ctrlKey
                      ? ev.keyCode - 64
                      : ev.keyCode + 32;
                    result.key =
                      EscapeSequences_1.C0.ESC + String.fromCharCode(keyCode);
                  }
          ...
          var Utf8ToUtf32 = (function() {
            ...
            Utf8ToUtf32.prototype.decode = function(input, target) {
              ...
              if (this.interim[0]) {
                ...
                var type =
                  (this.interim[0] & 0xe0) === 0xc0
                    ? 2
                    : (this.interim[0] & 0xf0) === 0xe0
                    ? 3
                    : 4;
        ...
        function(require, module, exports) {
          ...
          var AltClickHandler = (function() {
            function AltClickHandler(_mouseEvent, _terminal) {
              ...
              var coordinates = this._terminal.mouseHelper.getCoords(
                this._mouseEvent,
            ...
            AltClickHandler.prototype.move = function() {
              if (
                ...
                this._endCol !== undefined &&
                this._endRow !== undefined
              ) {
            ...
            AltClickHandler.prototype._moveToRequestedRow = function() {
              ...
              var rowsToMove =
                Math.abs(startRow - endRow) - this._wrappedRowsCount();
              return repeat(
                rowsToMove,
            ...
            AltClickHandler.prototype._wrappedRowsForRow = function(
              currentRow
            ) {
              var rowCount = 0;
              ...
              while (
                lineWraps &&
                currentRow >= 0 &&
                currentRow < this._terminal.rows
              ) {
                rowCount++;
                currentRow--;
            ...
            AltClickHandler.prototype._horizontalDirection = function() {
              ...
              if (
                (this._startCol < this._endCol && startRow <= this._endRow) ||
                (this._startCol >= this._endCol && startRow < this._endRow)
              ) {
                return "C";
              }
            ...
            AltClickHandler.prototype._bufferLine = function(
              startCol,
              startRow,
              endCol,
              endRow,
              ...
              return (
                bufferStr +
                this._terminal.buffer.translateBufferLineToString(
                  currentRow,
                  false,
                  startCol,
                  currentCol
      ...
      36: [
        function(require, module, exports) {
          ...
          var AddonManager = (function() {
            ...
            AddonManager.prototype._wrappedAddonDispose = function(
              loadedAddon
            ) {
      ...
      37: [
        function(require, module, exports) {
          ...
          var BufferLineApiView = (function() {
            ...
            BufferLineApiView.prototype.translateToString = function(
              trimRight,
              startColumn,
              endColumn
            ) {
              return this._line.translateToString(
                trimRight,
                startColumn,
                endColumn
              );
      ...
      38: [
        function(require, module, exports) {
          ...
          var BaseRenderLayer = (function() {
            ...
            BaseRenderLayer.prototype.setTransparency = function(
              terminal,
              alpha
            ) {
            ...
            BaseRenderLayer.prototype._refreshCharAtlas = function(
              ...
              this._charAtlas = CharAtlasCache_1.acquireCharAtlas(
                terminal,
                colorSet,
            ...
            BaseRenderLayer.prototype.drawChars = function(
              terminal,
              cell,
              x,
              y
              ...
              if (cell.isInverse()) {
                fg = cell.isBgDefault()
                  ? Types_2.INVERTED_DEFAULT_COLOR
                  : cell.getBgColor();
                bg = cell.isFgDefault()
                  ? Types_2.INVERTED_DEFAULT_COLOR
                  : cell.getFgColor();
                ...
                bg = cell.isBgDefault()
                  ? Types_1.DEFAULT_COLOR
                  : cell.getBgColor();
                fg = cell.isFgDefault()
                  ? Types_1.DEFAULT_COLOR
                  : cell.getFgColor();
              }
              var drawInBrightColor =
              ...
              this._currentGlyphIdentifier.chars =
                cell.getChars() || BufferLine_1.WHITESPACE_CELL_CHAR;
              this._currentGlyphIdentifier.code =
                cell.getCode() || BufferLine_1.WHITESPACE_CELL_CODE;
              this._currentGlyphIdentifier.bg = bg;
              this._currentGlyphIdentifier.fg = fg;
              this._currentGlyphIdentifier.bold =
                cell.isBold() && terminal.options.enableBold;
            ...
            BaseRenderLayer.prototype._drawUncachedChars = function(
              terminal,
              cell,
              x,
              y
              ...
              if (cell.isInverse()) {
                if (cell.isBgDefault()) {
                  ...
                  this._ctx.fillStyle =
                    "rgb(" +
                    BufferLine_1.AttributeData.toColorRGB(
                      cell.getBgColor()
                    ).join(",") +
                    ")";
                } else {
            ...
            BaseRenderLayer.prototype._getFont = function(
              terminal,
              isBold,
              isItalic
            ) {
      ...
      39: [
        function(require, module, exports) {
          ...
          var CharacterJoinerRegistry = (function() {
            ...
            CharacterJoinerRegistry.prototype.registerCharacterJoiner = function(
              handler
            ) {
              var joiner = {
            ...
            CharacterJoinerRegistry.prototype.deregisterCharacterJoiner = function(
              joinerId
            ) {
            ...
            CharacterJoinerRegistry.prototype.getJoinedCharacters = function(
              row
            ) {
              ...
              for (var x = 0; x < line.getTrimmedLength(); x++) {
                ...
                if (
                  this._workCell.fg !== rangeAttrFG ||
                  this._workCell.bg !== rangeAttrBG
                ) {
                  if (x - rangeStartColumn > 1) {
                    var joinedRanges = this._getJoinedRanges(
                      lineStr,
                ...
                currentStringIndex +=
                  ...
                  BufferLine_1.WHITESPACE_CELL_CHAR.length;
              }
            ...
            CharacterJoinerRegistry.prototype._getJoinedRanges = function(
              line,
              startIndex,
              endIndex,
              lineData,
              ...
              for (var i = 1; i < this._characterJoiners.length; i++) {
                ...
                for (var j = 0; j < joinerRanges.length; j++) {
                  CharacterJoinerRegistry._mergeRanges(
                    joinedRanges,
                    joinerRanges[j]
                  );
                }
            ...
            CharacterJoinerRegistry.prototype._stringRangesToCellRanges = function(
              ranges,
              line,
              startCol
            ) {
          ...
          var CursorRenderLayer = (function(_super) {
            ...
            CursorRenderLayer.prototype._render = function(
              ...
              terminal.buffer.lines
                .get(cursorY)
                .loadCell(terminal.buffer.x, this._cell);
        ...
        function(require, module, exports) {
          ...
          var RenderCoordinator = (function(_super) {
            ...
            function RenderCoordinator(_renderer, _rowCount, screenElement) {
              ...
              _this._renderDebouncer = new RenderDebouncer_1.RenderDebouncer(
                function(start, end) {
            ...
            RenderCoordinator.prototype._onIntersectionChange = function(
              entry
            ) {
            ...
            RenderCoordinator.prototype.onSelectionChanged = function(
              start,
              end,
              columnSelectMode
            ) {
            ...
            RenderCoordinator.prototype.registerCharacterJoiner = function(
              handler
            ) {
              return this._renderer.registerCharacterJoiner(handler);
            };
            RenderCoordinator.prototype.deregisterCharacterJoiner = function(
              joinerId
            ) {
        ...
        function(require, module, exports) {
          ...
          var Renderer = (function(_super) {
            ...
            function Renderer(_terminal, _colors) {
              ...
              _this._characterJoinerRegistry = new CharacterJoinerRegistry_1.CharacterJoinerRegistry(
                _terminal
              );
              _this._renderLayers = [
                new TextRenderLayer_1.TextRenderLayer(
                  _this._terminal.screenElement,
                  0,
                  _this._colors,
                  _this._characterJoinerRegistry,
                  allowTransparency
                ),
            ...
            Renderer.prototype.onSelectionChanged = function(
              start,
              end,
              columnSelectMode
            ) {
        ...
        function(require, module, exports) {
          ...
          var SelectionRenderLayer = (function(_super) {
            ...
            SelectionRenderLayer.prototype._didStateChange = function(
              ...
              return (
                !this._areCoordinatesEqual(start, this._state.start) ||
                !this._areCoordinatesEqual(end, this._state.end) ||
                columnSelectMode !== this._state.columnSelectMode ||
                ydisp !== this._state.ydisp
              );
            };
            SelectionRenderLayer.prototype._areCoordinatesEqual = function(
              coord1,
              coord2
            ) {
              if (!coord1 || !coord2) {
        ...
        function(require, module, exports) {
          ...
          var TextRenderLayer = (function(_super) {
            ...
            function TextRenderLayer(
              ...
              var _this =
                _super.call(this, container, "text", zIndex, alpha, colors) ||
                this;
            ...
            TextRenderLayer.prototype._forEachCell = function(
              terminal,
              firstRow,
              lastRow,
              joinerRegistry,
              ...
              for (var y = firstRow; y <= lastRow; y++) {
                ...
                var joinedRanges = joinerRegistry
                  ? joinerRegistry.getJoinedCharacters(row)
                  : [];
                for (var x = 0; x < terminal.cols; x++) {
                  ...
                  if (joinedRanges.length > 0 && x === joinedRanges[0][0]) {
                    ...
                    cell = new CharacterJoinerRegistry_1.JoinedCellData(
                      this._workCell,
                  ...
                  if (!isJoined && this._isOverlapping(cell)) {
                    if (
                      lastCharX < line.length - 1 &&
                      line.getCodePoint(lastCharX + 1) ===
                        BufferLine_1.NULL_CELL_CODE
                    ) {
            ...
            TextRenderLayer.prototype._drawBackground = function(
              terminal,
              firstRow,
              lastRow
            ) {
              ...
              ctx.save();
              this._forEachCell(terminal, firstRow, lastRow, null, function(
                cell,
                x,
                y
              ) {
            ...
            TextRenderLayer.prototype._drawForeground = function(
              terminal,
              firstRow,
              lastRow
            ) {
                  ...
                  if (cell.isUnderline()) {
                    ...
                    if (cell.isInverse()) {
                      if (cell.isBgDefault()) {
                        ...
                        _this._ctx.fillStyle =
                          _this._colors.ansi[cell.getBgColor()].css;
                      }
                    } else {
                      if (cell.isFgDefault()) {
            ...
            TextRenderLayer.prototype._isOverlapping = function(cell) {
              ...
              var overlaps =
                Math.floor(this._ctx.measureText(chars).width) >
      ...
      48: [
        function(require, module, exports) {
          ...
          function acquireCharAtlas(
            ...
            var newConfig = CharAtlasUtils_1.generateConfig(
              scaledCharWidth,
              scaledCharHeight,
              terminal,
              colors
            ...
            var newEntry = {
              atlas: new charAtlasImplementations[
                terminal.options.experimentalCharAtlas
              ](document, newConfig),
              config: newConfig,
              ownedBy: [terminal]
            };
      ...
      49: [
        function(require, module, exports) {
          ...
          function generateStaticCharAtlasTexture(
            context,
            canvasFactory,
            config
          ) {
            var cellWidth =
              config.scaledCharWidth + Types_1.CHAR_ATLAS_CELL_SPACING;
            var cellHeight =
              config.scaledCharHeight + Types_1.CHAR_ATLAS_CELL_SPACING;
            ...
            ctx.restore();
            if (
              !("createImageBitmap" in context) ||
              Platform_1.isFirefox ||
              Platform_1.isSafari
            ) {
              return canvas;
            }
            var charAtlasImageData = ctx.getImageData(
              0,
              0,
              canvas.width,
              canvas.height
          ...
          function getFont(fontWeight, config) {
            return (
              fontWeight +
              " " +
              config.fontSize * config.devicePixelRatio +
              "px " +
              config.fontFamily
            );
          }
        ...
        function(require, module, exports) {
          ...
          var DynamicCharAtlas = (function(_super) {
            ...
            function DynamicCharAtlas(document, _config) {
              ...
              _this._width = Math.floor(
                TEXTURE_WIDTH / _this._config.scaledCharWidth
              );
              _this._height = Math.floor(
                TEXTURE_HEIGHT / _this._config.scaledCharHeight
              );
            ...
            DynamicCharAtlas.prototype._drawFromCache = function(
              ctx,
              cacheValue,
              x,
              y
            ...
            DynamicCharAtlas.prototype._drawToCache = function(glyph, index) {
              ...
              var imageData = this._tmpCtx.getImageData(
                0,
                0,
                this._config.scaledCharWidth,
                this._config.scaledCharHeight
              ...
              var isEmpty = false;
              if (!this._config.allowTransparency) {
                isEmpty = CharAtlasGenerator_1.clearColor(
                  imageData,
                  backgroundColor
                );
              }
            ...
            DynamicCharAtlas.prototype._addGlyphToBitmap = function(
              cacheValue
            ) {
              var _this = this;
              if (
        ...
        function(require, module, exports) {
          ...
          var StaticCharAtlas = (function(_super) {
            ...
            StaticCharAtlas.prototype._doWarmUp = function() {
              var _this = this;
              var result = CharAtlasGenerator_1.generateStaticCharAtlasTexture(
                window,
                this._canvasFactory,
                this._config
              );
            ...
            StaticCharAtlas.prototype.draw = function(ctx, glyph, x, y) {
              ...
              var charAtlasCellWidth =
                this._config.scaledCharWidth + Types_1.CHAR_ATLAS_CELL_SPACING;
              var charAtlasCellHeight =
                this._config.scaledCharHeight + Types_1.CHAR_ATLAS_CELL_SPACING;
              if (glyph.dim) {
        ...
        function(require, module, exports) {
          ...
          var DomRenderer = (function(_super) {
            ...
            function DomRenderer(_terminal, _colors) {
              ...
              _this._refreshRowElements(
                _this._terminal.cols,
                _this._terminal.rows
              );
              ...
              _this._updateDimensions();
              _this._injectCss();
              _this._rowFactory = new DomRendererRowFactory_1.DomRendererRowFactory(
                _terminal.options,
                document
              );
              _this._terminal.element.classList.add(
                TERMINAL_CLASS_PREFIX + _this._terminalClass
              );
              _this._terminal.screenElement.appendChild(_this._rowContainer);
              _this._terminal.screenElement.appendChild(
                _this._selectionContainer
              );
            ...
            DomRenderer.prototype._updateDimensions = function() {
              ...
              this._rowElements.forEach(function(element) {
                ...
                element.style.lineHeight =
                  _this.dimensions.actualCellHeight + "px";
            ...
            DomRenderer.prototype._injectCss = function() {
              ...
              styles +=
                this._terminalSelector +
                " span:not(." +
                DomRendererRowFactory_1.BOLD_CLASS +
                ") {" +
                ...
                (this._terminalSelector +
                  " span." +
                  DomRendererRowFactory_1.ITALIC_CLASS +
                  " {") +
                " font-style: italic;" +
                "}";
              styles +=
              ...
              styles +=
                ...
                FOCUS_CLASS +
                ") ." +
                DomRendererRowFactory_1.CURSOR_CLASS +
                " {" +
                ...
                (this._terminalSelector +
                  ...
                  DomRendererRowFactory_1.CURSOR_CLASS +
                  "." +
                  DomRendererRowFactory_1.CURSOR_BLINK_CLASS +
                  " {") +
                ...
                (this._terminalSelector +
                  ...
                  DomRendererRowFactory_1.CURSOR_CLASS +
                  "." +
                  DomRendererRowFactory_1.CURSOR_STYLE_BLOCK_CLASS +
                  " {") +
                ...
                (this._terminalSelector +
                  ...
                  DomRendererRowFactory_1.CURSOR_CLASS +
                  "." +
                  DomRendererRowFactory_1.CURSOR_STYLE_BAR_CLASS +
                  " {") +
                (" box-shadow: 1px 0 0 " +
            ...
            DomRenderer.prototype.onSelectionChanged = function(
              start,
              end,
              columnSelectMode
            ) {
              ...
              if (
                viewportCappedStartRow >= this._terminal.rows ||
                viewportCappedEndRow < 0
              ) {
                return;
              }
            ...
            DomRenderer.prototype._createSelectionElement = function(
              row,
              colStart,
              colEnd,
              rowCount
              ...
              element.style.height =
                rowCount * this.dimensions.actualCellHeight + "px";
              element.style.top = row * this.dimensions.actualCellHeight + "px";
              element.style.left =
                colStart * this.dimensions.actualCellWidth + "px";
              element.style.width =
                this.dimensions.actualCellWidth * (colEnd - colStart) + "px";
              return element;
            };
            ...
            DomRenderer.prototype.deregisterCharacterJoiner = function(
              joinerId
            ) {
              return false;
            };
            ...
            DomRenderer.prototype._setCellUnderline = function(
              x,
              x2,
              y,
              y2,
      ...
      57: [
        function(require, module, exports) {
          ...
          var DomRendererRowFactory = (function() {
            ...
            DomRendererRowFactory.prototype.createRow = function(
              lineData,
              isCursorRow,
              cursorStyle,
              cursorX,
              ...
              for (var x = Math.min(lineData.length, cols) - 1; x >= 0; x--) {
                if (
                  lineData.loadCell(x, this._workCell).getCode() !==
                    BufferLine_1.NULL_CELL_CODE ||
                  (isCursorRow && x === cursorX)
                ) {
                  lineLength = x + 1;
                  break;
                }
              ...
              for (var x = 0; x < lineLength; x++) {
                  ...
                  switch (cursorStyle) {
                    ...
                    case "underline":
                      charElement.classList.add(
                        exports.CURSOR_STYLE_UNDERLINE_CLASS
                      );
                      break;
                    default:
                      charElement.classList.add(
                        exports.CURSOR_STYLE_BLOCK_CLASS
                      );
                      break;
                  }
                }
                ...
                if (this._workCell.isFgRGB()) {
                  ...
                  charElement.classList.add(
                    "xterm-" + (swapColor ? "b" : "f") + "g-" + fg
                  );
                } else if (swapColor) {
                  charElement.classList.add(
                    "xterm-bg-" + Types_1.INVERTED_DEFAULT_COLOR
                  );
                }
                if (this._workCell.isBgRGB()) {
                  ...
                  charElement.classList.add(
                    "xterm-fg-" + Types_1.INVERTED_DEFAULT_COLOR
                  );
                }
          ...
          var ColorManager = (function() {
            ...
            ColorManager.prototype.setTheme = function(theme) {
              ...
              this.colors.cursorAccent = this._parseColor(
                theme.cursorAccent,
                DEFAULT_CURSOR_ACCENT,
                true
              );
              this.colors.selection = this._parseColor(
                theme.selection,
                DEFAULT_SELECTION,
                true
              );
            ...
            ColorManager.prototype._parseColor = function(
              css,
              fallback,
              allowTransparency
            ) {
              ...
              if (typeof this._ctx.fillStyle !== "string") {
                console.warn(
                  "Color: " + css + " is invalid using fallback " + fallback.css
                );
                return fallback;
              }
              ...
              if (!allowTransparency && data[3] !== 0xff) {
                console.warn(
                  "Color: " +
                    css +
                    " is using transparency, but allowTransparency is false. " +
      ...
      60: [
        function(require, module, exports) {
          ...
          var RenderDebouncer = (function() {
            ...
            RenderDebouncer.prototype.refresh = function(
              rowStart,
              rowEnd,
              rowCount
            ) {
              ...
              this._rowStart =
                this._rowStart !== undefined
                  ? Math.min(this._rowStart, rowStart)
                  : rowStart;
              this._rowEnd =
                this._rowEnd !== undefined
                  ? Math.max(this._rowEnd, rowEnd)
                  : rowEnd;
              if (this._animationFrame) {
                return;
              }
